            ...
            <div className="flex gap-2">
              ...
              <div className="relative flex-1">
                <select
                  ...
                  className="w-full h-14 px-2 bg-surface border border-transparent focus:bg-white focus:border-black/10 rounded-2xl text-base font-semibold text-text-main outline-none appearance-none transition-all text-center"
                >
              ...
              <div className="relative flex-1">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (isNaN(val)) setTimeMinute('');
                    else if (val > 59) setTimeMinute('59');
                    else if (val < 0) setTimeMinute('00');
                    else setTimeMinute(val.toString());
                  }}
                  onBlur={() => {
                    if (timeMinute === '' || isNaN(parseInt(timeMinute))) setTimeMinute('00');
                    else setTimeMinute(parseInt(timeMinute).toString().padStart(2, '0'));
                  }}
                  placeholder="00"
                  className="w-full h-14 px-2 bg-surface border border-transparent focus:bg-white focus:border-black/10 rounded-2xl text-base font-semibold text-text-main outline-none transition-all text-center"
                />
              </div>
